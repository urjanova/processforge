...
class Pump(BaseUnitMixin, PumpEOMixin):
    ...
    def __init__(self, name, delta_p=1e5, efficiency=0.8, **kwargs):
        self.name = name
    ...
    def _run_impl(self, inlet):
        ...
        based on the pump's delta_p and efficiency, and returns the modified outlet stream.
        ...
        Returns:
            dict: The outlet stream dictionary with updated 'P', 'T', 'power', and 'unit' keys.
                - 'P': Outlet pressure (inlet P + delta_p).
        ...
        # Shaft power (J/s)
        power = (mass_flow / rho) * self.delta_p / max(self.efficiency, 1e-6)
